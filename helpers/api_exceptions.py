...
async def request_exception_handler(request: Request, exc: RequestValidationError):  # pylint: disable=[W0613]
...
async def response_exception_handler(request: Request, exc: ResponseValidationError):  # pylint: disable=[W0613]
